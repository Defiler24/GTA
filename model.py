...
class BotNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=101, resolution=(224, 224)):
...
def ResNet50(num_classes=101, resolution=(224, 224)):
...
def BotNet50(num_classes=101, resolution=(224, 224)):
    return BotNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, resolution=resolution)

def ResNet18(num_classes=101, resolution=(224, 224)):
    return ResNet(Bottleneck, [2, 2, 2, 2], num_classes=num_classes, resolution=resolution)

def BotNet18(num_classes=101, resolution=(224, 224)):
    return BotNet(Bottleneck, [2, 2, 2, 2], num_classes=num_classes, resolution=resolution)
