...
parser.add_argument('--checkpoints', type=str, default="/bzh/GTA/models/95_model.pth")
parser.add_argument('--local_rank', default=0, type=int)
parser.add_argument('-p', '--print-freq', default=10, type=int, metavar='N')
parser.add_argument('--schedule', type=int, nargs='+', default=[80,90])
...
def main_worker(local_rank, nprocs, args):
    ...
    if args.local_rank == 0:
        writer = SummaryWriter(
            log_dir=f'runs/B4_n=2_m=12_bs={args.batch_size}'
        )
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.local_rank == 0 and is_best and epoch > 50:
